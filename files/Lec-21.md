[![Everything Is AWESOME](../files/youtube.png)](https://youtu.be/brqzGdFk7dc "Everything Is AWESOME")
...
- print a to z letters using for loop

- use `while` loop to print 1 to 10 numbers 

## Script

[ক্লাসের script পাওয়া যাবে এখানে](https://github.com/Rashedul/R-Tutorials/blob/master/scripts/Lec-21.R) 
